    ...
    if (goodsList) {
        ...
        getGoods() // получение спсика товаров от сервера
            .then(({ goods, pages, page }) => { // деструктуризация
                ...
                // goods-item__to-cart класс кнопки "В корзину", goods-item__to-cart--remove клас кнопки "Убрать из корзины"
...
try {
    ...
    if (card) {
        ...
        }); // чтобы прb нажтии на =/- чило товраов увлиичвалось на станице товара(card.html)
    }
